        ...
        if (empty($info)) {
              ...
              <?php
                foreach ($info as $val) {
                  ...
                  <tr class="detalhes_usuario">
                    ...
                    <td class="apagar" id_apaga="<?php echo $val['id']; ?>"><i class="fa fa-trash fa-lg"></i> </td>
                  </tr>
                <?php } ?>
            </tbody>
          </table>
          <ul class="pagination">
            ...
            <?php
              ...
              if ($pagina > $lim_links) {
                echo "<li style='text-transform: uppercase;font-weight: 700; color: #222; font-size: 1.2em;'>. . .</li>";
              }
              ...
              if ($num_paginas > 0 && $pagina <= $num_paginas) {
                for ($i = $inicio; $i <= $fim; $i++) {
                  ...
                  if ($i == $pagina) { ?>
                  <li><a style="text-transform: uppercase;font-weight: 700; background: #3574B9; color: white;" href="consultar_produto_resultado.php?pagina=<?php echo $i; ?>"><?php echo $i + 1; ?></a></li>
                <?php } else { ?>
            ...
            <?php
                ...
                if ($pagina < $num_paginas - $lim_links - 1) {
                  echo "<li style='text-transform: uppercase;font-weight: 700; color: #222; font-size: 1.2em;'>. . .</li>";
                }
              }
              ?>
