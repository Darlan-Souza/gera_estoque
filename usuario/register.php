        ...
        <div class="row">
          <form class="col s12">
            ...
            <div class="modal-footer">
              <center><button id="registrar_usuario" class="modal-action modal-close waves-effect waves-light btn medium-small darken-3">Registrar <i class="fa fa-check"></i></button></center>
            </div>
          </form>
        </div>
      </div>
